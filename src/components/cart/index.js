...
const Cart = () => {
    ...
    useEffect(() => {
        const total = cart?.cartItems.reduce((sum, item) => sum + (item.price || 0), 0);
    ...
    <div className='bg-white py-4'>
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='overflow-y-auto'>
                <table className='mt-12 w-full border-collapse divide-y'>
                    ...
                    <tbody className='whitespace-nowrap divide-y'>
                        {
                            cart?.cartItems.map(item=><tr key={item.id} >
            ...
            <div className='max-w-xl ml-auto mt-6'>
                <p className="text-xl font-bold mt-4">Total: ${totalAmount}
